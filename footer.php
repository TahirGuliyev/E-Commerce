			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						<li class="fphone"><?php echo $settingTake['setting_tel']; ?> </li>
						<li class="fmobile"><?php echo $settingTake['setting_gsm']; ?></li>
						<li class="fmail lastone"><?php echo $settingTake['setting_mail']; ?></li>
					</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;All rights reserved by <a href="#">tahirguliyev.com</a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						<a href="http://<?php echo $settingTake['setting_facebook']; ?>" class="ftwitter">twitter</a>
						<a href="http://<?php echo $settingTake['setting_twitter']; ?>" class="ffacebook">facebook</a>
						<a href="http://<?php echo $settingTake['setting_instagram']; ?>" class="fa instagram">flickr</a>
						<a href="http://<?php echo $settingTake['setting_youtube']; ?>" class="fa youtube">feed</a>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div><!--footer Share-->
